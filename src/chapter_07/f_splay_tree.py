...
def test():
    ...
    splay_tree.insert(10, "A")
    splay_tree.insert(20, "B")
    splay_tree.insert(5, "C")
    assert splay_tree.find(20) == "B"
    assert splay_tree.find(5) == "C"
    assert splay_tree.find(10) == "A"
    assert splay_tree.find(15) is None
